...
O pacote ainda não está publicado no PyPI. Instale a tag da versão no GitHub (`@v0.3.0` quando a 0.3.0 for
publicada; `@v0.2.0` instala a versão anterior), ou a partir do repositório clonado com `python -m pip install .`;

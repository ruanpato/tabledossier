...
| Document | Content |
| --- | --- |
| [architecture.md](architecture.md) | Modules, notebook composition, execution per table |
| [contract.md](contract.md) | `profile.json` fields, metric semantics and encoding, manifests |
| [configuration.md](configuration.md) | Every configuration option, filters, checks, relationships |

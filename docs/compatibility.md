...
Last reviewed: 2026-09-22 (release 0.3.0).
...
| Continuous integration | GitHub Actions [run 35708638923](https://github.com/ruanpato/tabledossier/actions/runs/35708638923) (commit `a2ac9db`, release 0.3.0): Ubuntu with Python 3.10–3.14; Windows and macOS with Python 3.12; Spark jobs on Ubuntu with Temurin 17 | All 12 jobs green: lint + mypy, unit tests on every OS/Python (252 each), PySpark 3.5 + Delta (74 passed), Spark Connect 3.5 + Delta (74 passed), PySpark 4.0 (70 passed, 4 skipped), Spark Connect 4.0 (70 passed, 4 skipped) |

...
| Continuous integration | GitHub Actions [run 35685482909](https://github.com/ruanpato/tabledossier/actions/runs/35685482909) (commit `6a3206d`): Ubuntu with Python 3.10–3.14; Windows and macOS with Python 3.12; Spark jobs on Ubuntu with Temurin 17 | All 12 jobs green: lint + mypy, unit tests on every OS/Python (198 each), PySpark 3.5 + Delta (49 passed), Spark Connect 3.5 + Delta (49 passed), PySpark 4.0 (46 passed, 3 skipped), Spark Connect 4.0 (46 passed, 3 skipped) |

...
| Release workflow | GitHub Actions dry run on pull requests ([run 35732144301](https://github.com/ruanpato/tabledossier/actions/runs/35732144301), PR #11) | Version check, build, 279 unit tests against the installed wheel, notes from the CHANGELOG, `SHA256SUMS` verified, artefacts uploaded; the publish job was skipped (no tag). The draft release itself has not been created by the workflow yet |
